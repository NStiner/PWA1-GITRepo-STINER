...
//{KEY : Value} pairings,
	...
	/* accessing object properties
	 ...
	 2. index notation using a variable as the index //person[personAge]
	 3. index notation using a string //person['secretAgent']
...
// setter
	person['age'] = '40';
	//if age didn't exist, it would create age
...
//nested objects
	...
	console.log(person['birthday']['month']); //index notation
...
//Window DOM object
	...
	for (i = 0, max = anchor.length; i < max; i++) {
	...
	var nav = document.querySelectorAll('#nav li:last-child'); //:last-child is a filter
	console.log(nav);
	...
	var nav = ducument.querySelector('#nav');
	console.log(nav);
	...
	for (var i = 0, max = navLinks.length; i < max; i++) {
		...
		navLinks[i].firstChild.setAttributes('class', 'navitem active');
	...
	navLinks[i].firstChild.stAttribute('href', 'http://google.com');
	//};

	var navLinks = document.querySelectorAll('#nav a');
	console.log(navLinks[1].innherHTML);
