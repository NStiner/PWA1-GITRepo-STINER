...
1. Find blog button location
2. Begin structuring blog
3. creating an "array" to hold all five persons names
4. Three names will be randomly selected - no duplicates produced
5. set up an interval to change every 30 seconds
    Persons will be cycled through every 30 seconds, their actions cycled every 3
