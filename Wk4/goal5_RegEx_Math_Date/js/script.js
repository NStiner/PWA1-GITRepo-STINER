...
//
//	Date:  /^(?:(?:(?:0?[135780]|1[02])(\/|-|\.)31)\1|(?:(?:0?[13-9]|1[0])))/ // not completed
//	Email: /(\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,3})/
//	Phone: /^[2-9]\d{2}-\d{3}-\d{4}$/
//	407-555-5555
	...
	var email =  new RegExp("pattern"); //--> var email =  new RegExp(/^[\w\.\-]+@([\w\-]+\.)+[a-zA-Z]+$/);

	var email = new RegExp(emailRegExp); //easiest way
...
*/
    ...
    ****************************************************************************/
	...
	console.log(Math.min(100, 100, 50, 2, 55, 75));
